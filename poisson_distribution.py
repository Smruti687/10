...
plt.fill_between(x, 0, y, where=(x==5), alpha=0.6, label='x = 5')
plt.fill_between(x, 0, y, where=(x<=12), alpha=0.4, label='x ≤ 12')
plt.fill_between(x, 0, y, where=(x>=15), alpha=0.4, label='x ≥ 15')
plt.fill_between(x, 0, y, where=(x>=10)&(x<=15), alpha=0.4, label='10 ≤ x ≤ 15')
